import{_ as n,c as a,a0 as p,o as t}from"./chunks/framework.CMtr6uOw.js";const f=JSON.parse('{"title":"附录B. 文件格式","description":"","frontmatter":{"sidebarDepth":2},"headers":[],"relativePath":"algorithm/RTKLIB手册/06-appendixB.md","filePath":"algorithm/RTKLIB手册/06-appendixB.md"}'),e={name:"algorithm/RTKLIB手册/06-appendixB.md"};function l(i,s,d,c,r,o){return t(),a("div",null,s[0]||(s[0]=[p(`<h1 id="附录b-文件格式" tabindex="-1">附录B. 文件格式 <a class="header-anchor" href="#附录b-文件格式" aria-label="Permalink to &quot;附录B. 文件格式&quot;">​</a></h1><h2 id="b-1-定位解算文件" tabindex="-1">B.1 定位解算文件 <a class="header-anchor" href="#b-1-定位解算文件" aria-label="Permalink to &quot;B.1 定位解算文件&quot;">​</a></h2><p><strong>描述</strong></p><p>定位解算文件仅仅是RTKNAVI或RTKPOST输出的文本文件。该文件通过CR/LF分隔为记录或行。每条记录包含多个字段。下表展示了定位解算文件的格式。</p><table><tr><th>序号</th><th>记录/域</th><th>描述</th><th>备注</th></tr><tr><td>1</td><td>文件头</td><td> 以“%”开头的行是文件头行。文件头行包含一些额外信息或处理选项，如下所示。<br> % program : 程序版本<br> % inp file : 输入文件路径<br> % obs start: 观测数据开始时间（GPS时间）<br> % obs end: 观测数据结束时间（GPS时间）<br> % pos mode: 定位模式选项<br> % freqs: 频率选项<br> % solution: 解算类型选项<br> % elev mask: 仰角遮蔽角选项<br> % snr mask: 信噪比遮蔽选项<br> % ionos est: 电离层参数估计选项<br> % tropos est: 对流层参数估计选项<br> % amb res: 整数模糊度解算选项<br> % val thres: 整数模糊度验证选项<br> % ref pos: 基准站天线的位置 </td><td></td></tr><tr><td>2</td><td>字段指示符</td><td> 以“%”开头的字段指示符行位于文件头之后。为了识别字段格式，RTKLIB使用这些行。请不要删除它们。 </td><td></td></tr><tr><td>3</td><td>解决方案主体</td><td> 解算主体包含以下字段。字段内容会根据定位选项而变化。 </td><td></td></tr><tr><td>(1)</td><td>Time</td><td> 解算历元时间，表示真实的接收机信号接收时间（不是接收机时钟指示的时间）。格式会根据选项变化。<br> yyyy/mm/dd HH:MM:SS.SSS ：<br> 日历时间，以GPST、UTC或JST表示，时间系统在字段指示符中标识。<br> WWWW SSSSSSS.SSS ：<br> GPS周和周内时间（TOW，以秒为单位）。 </td><td></td></tr><tr><td>(2)</td><td>接收机位置</td><td> 根据定位选项变化的流动站接收天线或标记位置的估计值。<br> +ddd.ddddddddd +ddd.dddddddd hhhh.hhhh ：<br> 纬度和经度（度）以及高度（米）。负值表示南纬或西经。高度根据定位选项表示为椭球高度或大地高度。<br> +ddd mm ss.sss +ddd mm ss.sss hhhh.hhhh ：<br> 纬度和经度（度、分、秒）以及高度（米）。<br> +xxxxxxxxx.xxxx +yyyyyyyyy.yyyy +zzzzzzzz.zzzz ：<br> ECEF坐标系中的X/Y/Z分量（米）。<br> +eeeeeeeee.eeee +nnnnnnnnn.nnnn +uuuuuuuuu.uuuu ：<br> 基线向量的E/N/U分量（米）。本地坐标系参考流动站位置。 </td><td></td></tr><tr><td>(3)</td><td>Quality flag (Q)</td><td> 表示解算质量的标志。<br> 1: Fixed，通过载波相对定位得到的解算结果，并且整数模糊度已正确解算。<br> 2: Float，通过载波相对定位得到的解算结果，但整数模糊度未解算。<br> 3: Reserved<br> 4: DGPS,，通过码基差分GPS解算或带有SBAS修正的单点定位得到的解算结果<br> 5: Single，通过单点定位得到的解算结果 </td><td></td></tr><tr><td>(4)</td><td>Number of valid satellites (ns)</td><td> 用于解算估计的有效卫星数量。 </td><td></td></tr><tr><td>(5)</td><td> Standard deviations(sdn, sde, sdu, sdne, sdeu, sdun) </td><td> 假设先验误差模型和定位选项中的误差参数，解算的估计标准差。 sdn、sde或sdu分别表示标准差的北（N）、东（E）或上（U）分量，单位为米。sdne、sdeu或sdun的绝对值表示估计协方差矩阵的NE、EU或UN分量的绝对值的平方根。符号表示协方差的符号。利用所有这些值，用户可以重构完整的协方差矩阵。 </td><td></td></tr><tr><td>(6)</td><td>Age of differential (age)</td><td> 流动站接收机与基准站观测数据历元之间的时间差，单位为秒。 </td><td></td></tr><tr><td>(7)</td><td> Ratio factor (ratio) </td><td> 标准整数模糊度验证策略中“ratio-test”的比率因子。该值表示次佳整数向量与最佳整数向量的残差平方和的比率。 </td><td></td></tr><tr><td>(8)</td><td>Velocity (optional) (vn,ve,vu, sdvn,sdve sdvu,sdvne sdveu,sdvun)</td><td> 速度分量及其标准差（从选项菜单启用） </td><td></td></tr></table><p><strong>示例</strong></p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>% program : RTKLIB ver.2.3.0b</span></span>
...
<span class="line"><span>2009/07/15 07:12:10.000 32.560273212 -116.953525455 118.6731 1 10 0.0077 0.0080 0.0568 -0.0034 0.0060 -0.0110 0.00 7.9</span></span></code></pre></div><h2 id="b-2-sbas-日志文件" tabindex="-1">B.2 SBAS 日志文件 <a class="header-anchor" href="#b-2-sbas-日志文件" aria-label="Permalink to &quot;B.2 SBAS 日志文件&quot;">​</a></h2><p><strong>描述</strong></p><p>SBAS日志文件是RTKCONV的输出，这是一个文本文件，其中每一行包含由GPS/GNSS接收机捕获的SBAS消息。下表展示了SBAS日志文件的格式。</p><table><tr><th>序号</th><th>记录/域</th><th>描述</th><th>备注</th></tr><tr><td>1</td><td>SBAS messages</td><td>一行包含一个SBAS导航数据帧，该数据帧由以下字段组成。</td><td></td></tr><tr><td>(1)</td><td>GPS week number</td><td>SBAS导航数据帧的GPS周号。</td><td></td></tr><tr><td>(2)</td><td>Time of week</td><td>SBAS导航数据帧的周内时间（以秒为单位）。</td><td></td></tr><tr><td>(3)</td><td>PRN number</td><td> 传输导航数据的SBAS卫星的PRN编号 </td><td></td></tr><tr><td>(4)</td><td>Message type</td><td> 帧中SBAS消息的类型ID（0 - 63）。详细信息请参考SBAS规范：<br> RTCA/DO-229C，全球定位系统/广域增强系统机载设备的最低运行性能标准 </td><td></td></tr><tr><td>(5)</td><td>Separator</td><td>:</td><td></td></tr><tr><td>(6)</td><td>SBAS message</td><td> 226位SBAS消息的十六进制转储，不包含24位奇偶校验字段。消息尾部用0填充以对齐到8位边界。详细消息格式请参考SBAS规范。 </td><td></td></tr></table><p><strong>示例</strong></p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>1471 349007 137 25 : C666A0A7F1FE6000027F80000003468000000000000000000000000000</span></span>
...
<span class="line"><span>1471 349020 129  4 : 53129FFFFF5FFDFFDFFDFFFFC3FA9FFDFFDFFDFFDFFF9BBBBB33FFFFC0</span></span></code></pre></div><h2 id="b-3-解算状态文件" tabindex="-1">B.3 解算状态文件 <a class="header-anchor" href="#b-3-解算状态文件" aria-label="Permalink to &quot;B.3 解算状态文件&quot;">​</a></h2><p><strong>描述</strong></p><p>解算状态文件是RTKNAVI或RTKPOST的输出，是一个包含定位过程内部状态的文本文件。内部状态包括卡尔曼滤波器的估计状态和测量残差，用于分析解算质量。下表展示了解算状态文件的格式。</p><table><tr><th>序号</th><th>记录/域</th><th>描述</th><th>备注</th></tr><tr><td>1</td><td>Position States</td><td> 滤波器中估计的流动站位置。记录的格式如下。<br> \`$POS,week,tow,stat,posx,posy,posz,posxf,posyf,poszf\` <br> week/tow : GPS周号/周内时间（秒）<br> stat : 解算状态<br> posx/posy/posz : ECEF坐标系中的位置x/y/z（米，浮点数）<br> posxf/posyf/poszf : ECEF坐标系中的位置x/y/z（米，固定解） </td><td></td></tr><tr><td>2</td><td>Velocity/Acceleration States</td><td> 滤波器中估计的流动站速度和加速度。记录的格式如下。<br> \`$VELACC,week,tow,stat,vele,veln,velu,acce,accn,accu,velef,velnf,veluf,accef,accnf,accuf\`<br> week/tow : GPS周号/周内时间（秒）<br> stat : 解算状态<br> vele/veln/velu : 速度东/北/上（米/秒，浮点数）<br> acce/accn/accu : 加速度东/北/上（米/秒²，浮点数）<br> velef/velnf/veluf : 速度东/北/上（米/秒，固定解）<br> accef/accnf/accuf : 加速度东/北/上（米/秒²，固定解） </td><td></td></tr><tr><td>3</td><td>Receiver Clock-bias States</td><td> 估计的接收机钟差参数。记录的格式如下。<br> \`$CLK,week,tow,stat,rcv,clk1,clk2,clk3,clk4,cmn_bias\`<br> week/tow : GPS周号/周内时间（秒）<br> stat : 解算状态<br> clk1 : 接收机钟差GPS（纳秒）<br> clk2 : 接收机钟差GLONASS-GPS（纳秒）<br> clk3 : 接收机钟差Galileo-GPS（纳秒）<br> clk4 : 接收机钟差北斗-GPS（纳秒）<br> cmn_bias : 从所有信号中移除的公共相位偏差 </td><td></td></tr><tr><td>4</td><td>Ionosphere Parameter States</td><td> 估计的电离层参数（L1电离层延迟差）。记录的格式如下。<br> \`$ION,week,tow,stat,sat,az,el,ion,ion-fixed\`<br> week/tow : GPS周号/周内时间（秒）<br> stat : 解算状态<br> sat : 卫星ID<br> az/el : 方位角/仰角（度）<br> ion : L1电离层延迟（米，浮点数）<br> ion-fixed : L1电离层延迟（米，固定解） </td><td></td></tr><tr><td>5</td><td>Troposphere Parameter States</td><td> 估计的对流层参数（垂直对流层延迟残差）。记录的格式如下。<br> \`$TROP,week,tow,stat,rcv,ztd,ztdf\`<br> week/tow : GPS周号/周内时间（秒）<br> stat : 解算状态<br> rcv : 接收机（1:流动站，2:基准站）<br> ztd : 顶点总延迟（米，浮点数）<br> ztdf : 顶点总延迟（米，固定解） </td><td></td></tr><tr><td>6</td><td>Receiver H/W bias States</td><td> 估计的GLONASS接收机H/W偏差差。记录的格式如下。<br> \`$HWBIAS,week,tow,stat,frq,bias,biasf\`<br> week/tow : GPS周号/周内时间（秒）<br> stat : 解算状态<br> frq : 频率（1:L1,2:L2,3:L5,...）<br> bias : H/W偏差系数（米/兆赫，浮点数）<br> biasf : H/W偏差系数（米/兆赫，固定解） </td><td></td></tr><tr><td>7</td><td>Residuals</td><td> 伪距和载波相位观测值的残差。记录的格式如下。<br> \`$SAT,week,tow,sat,frq,az,el,resp,resc,vsat,snr,fix,slip,lock,outc,slipc,rejc,icbias,bias,bias_var,lambda\`<br> week/tow : GPS周号/周内时间（秒）<br> sat/frq : 卫星ID/频率（1:L1,2:L2,3:L5,...）<br> az/el : 方位角/仰角（度）<br> resp : 伪距残差（米）<br> resc : 载波相位残差（米）<br> vsat : 有效数据标志（0:无效，1:有效）<br> snr : 信号强度（dbHz）<br> fix : 模糊度标志（0:无数据，1:不是AR集合的一部分，2:是AR集合的一部分，3:是保持集合的一部分）<br> slip : 周跳标志（位1:周跳，位2:奇偶性未知）<br> lock : 载波锁定计数<br> outc : 数据中断计数<br> slipc : 周跳计数<br> rejc : 数据拒绝（异常值）计数<br> icbias : 通道间偏差（GLONASS）<br> bias : 相位偏差<br> bias_var : 相位偏差的方差<br> lambda : 波长 </td><td></td></tr></table><p><strong>示例</strong></p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$POS,1557,432000.000,2,-3869295.9628,3436570.2567,3717367.6546,0.0000,0.0000,0.0000</span></span>
